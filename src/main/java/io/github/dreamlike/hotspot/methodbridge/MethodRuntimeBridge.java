...
final class MethodRuntimeBridge {
    ...
    private static final MethodHandle JAVA_THREAD_CURRENT = HotSpotMethodBridge.LINKER.downcallHandle(
            MemorySegment.ofAddress(HotSpotMethodBridge.NATIVE_SYMBOLS.threadCurrent()),
            FunctionDescriptor.of(ValueLayout.ADDRESS));
    private static final MethodHandle WHITEBOX_COMPILE_METHOD = HotSpotMethodBridge.LINKER.downcallHandle(
    ...
    private static final MethodHandle METHOD_GET_I2C_ENTRY = HotSpotMethodBridge.LINKER.downcallHandle(
